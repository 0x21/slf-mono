...
import { getAuthOptions, isSecureContext } from "@fulltemplate/auth/src/config";

import { AUTH_COOKIE_PATTERN, EXPO_COOKIE_NAME } from "~/lib/constants";
...
async function handleExpoSigninCallback(req: NextRequest, redirectURL: string) {
  // console.log("handleExpoSigninCallback", redirectURL);
...
export const GET = async (
  ...
  // console.log("isExpoSignIn", isExpoSignIn);
  // console.log("isExpoCallback", isExpoCallback);
  // console.log("nextauthAction", nextauthAction);
