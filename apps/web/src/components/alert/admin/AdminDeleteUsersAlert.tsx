...
const AdminDeleteUsersAlert = ({
  ...
  const mutation = useMutation(api.admin.deleteUsers.mutationOptions());
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-left">
            Are you sure you want to delete {userIds.length} users? All data
...
export default AdminDeleteUsersAlert;
