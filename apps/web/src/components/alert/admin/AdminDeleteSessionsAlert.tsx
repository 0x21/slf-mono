...
const AdminDeleteSessionsAlert = ({ open, setOpen, sessionIds }: IProps) => {
  const api = useTRPC();
  const queryClient = useQueryClient();

  const mutation = useMutation(api.admin.deleteSessions.mutationOptions());
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-left">
            Are you sure you want to delete {sessionIds.length} sessions?
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
...
export default AdminDeleteSessionsAlert;
