...
const AdminRemoveRequirePasswordChangeAlert = ({
  open,
  setOpen,
  userId,
  email,
  ...
  const mutation = useMutation(
    api.admin.removePasswordChangeRequirement.mutationOptions(),
  );
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-left">
            Are you sure you want to remove the requirement for password change
            for this user (
...
export default AdminRemoveRequirePasswordChangeAlert;
