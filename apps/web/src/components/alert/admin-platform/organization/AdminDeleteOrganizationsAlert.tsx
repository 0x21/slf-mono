...
const AdminDeleteOrganizationsAlert = ({
  open,
  setOpen,
  slugs,
  onSuccess,
  ...
  const mutation = useMutation(
    api.adminPlatform.deleteOrganizations.mutationOptions(),
  );
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-left">
            Are you sure you want to delete {slugs.length} organizations? All
...
export default AdminDeleteOrganizationsAlert;
