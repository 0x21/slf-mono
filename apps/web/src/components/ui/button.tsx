  ...
  "focus-visible:ring-ring inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus-visible:ring-1 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        positive: "bg-green-500 text-white shadow-sm hover:bg-green-500/90",
        destructive:
        ...
        tremor:
          "border border-gray-200 bg-white text-gray-500 shadow-sm hover:border-gray-300 hover:bg-gray-50",
        blank: "border border-gray-200 bg-white shadow-sm",
      },
      size: {
